...
from mada.interfaces.gradio.main import create_gradio_app, gradio_entrypoint, run_gradio
...
class TestMADAGradioCmd:
    ...
    class TestGradioEntrypoint:
        ...
        def test_gradio_entrypoint_applies_port_and_share_overrides(self):
            """
        ...
        def test_gradio_entrypoint_exits_if_no_interface_config(self):
            """
    ...
    class TestRunGradio:
        ...
        def test_run_gradio_launches_interface_with_defaults(self):
            ...
            with patch("mada.interfaces.gradio.main.MCPGradioClientSession") as mock_client_cls, \
                ...
                # Since config.interface is None, defaults should be used: port 7860, share False
        ...
        def test_run_gradio_launches_interface_with_configured_port_and_share(self):
            """
            Test that the `run_gradio` function launches the Gradio interface
...
class TestMADAOpenAIApiCmd:
    ...
    class TestCreateOpenAIApiApp:
        ...
        def test_models_endpoint_without_v1_returns_exposed_model(self):
            """
        ...
        def test_health_endpoint_reports_not_initialized_before_first_chat(self):
            """
        ...
        def test_chat_completions_returns_503_when_orchestrator_startup_fails(self):
            """
...
class TestMADACLICmd:
    ...
    class TestMADACLIInterface:
        ...
        async def test_cli_interface_run_quit_immediately(self):
            ...
            # Mock MADAOrchestrator context manager and methods
            ...
            with patch("mada.interfaces.cli.main.MADAOrchestrator", return_value=orchestrator_mock), \
                ...
                # Ensure orchestrator is used
                orchestrator_mock.initialize_orchestrator.assert_awaited_once_with(
                    config.agents, config.mcp_servers
                )

                # Because user typed "quit" immediately, process_message should not be called
        ...
        @pytest.mark.asyncio
        async def test_cli_interface_run_processes_one_message(self):
            """
            ...
            # Mock orchestrator used in `async with`
