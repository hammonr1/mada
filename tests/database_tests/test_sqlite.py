...
class TestSQLiteChatDatabaseUnit:
    ...
    class TestSaveSession:
        ...
        @patch("mada.core.database.sqlite.datetime")
        def test_save_session_handles_empty_messages(self, mock_datetime, sqlite_db_unit):
    ...
    class TestLoadSession:
        ...
        def test_load_session_returns_messages(self, sqlite_db_unit):
            ...
            db, mock_conn = sqlite_db_unit
            mock_conn.__enter__.return_value.execute.return_value.fetchone.return_value = [json.dumps([{"user": "Hello", "bot": "Hi"}])]
    ...
    class TestFlushDatabase:
        ...
        def test_flush_database_removes_all_data(self, mock_confirm_flush, sqlite_db_unit):
            ...
            mock_conn.__enter__.return_value.execute.assert_called_once_with("DELETE FROM sessions")

        @patch.object(SQLiteChatDatabase, "confirm_db_flush", return_value=False)
        def test_flush_database_cancels_on_user_decline(self, mock_confirm_flush, sqlite_db_unit):
...
class TestSQLiteChatDatabaseIntegration:
    ...
    class TestLoadSession:
        ...
        def test_load_session_returns_empty_list_if_not_found(self, sqlite_db_integration):
    ...
    class TestListSessions:
        ...
        def test_list_sessions_returns_empty_list_if_no_sessions(self, sqlite_db_integration):
    ...
    class TestFlushDatabase:
        ...
        def test_flush_database_removes_all_data(self, mock_input, sqlite_db_integration):
        ...
        def test_flush_database_cancels_on_user_decline(self, mock_input, sqlite_db_integration):
            """Test that flush_database does not remove data if user declines."""
